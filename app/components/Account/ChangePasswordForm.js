...
export default function ChangePasswordForm(props) {
    ...
    const onSubmit = async () => {
        ...
        if(!formData.password || !formData.newPassword || !formData.repeatNewPassword) {
            ...
            setIsLoading(true);
            await reauthenticate(formData.password).then(async () => { //colocando el async en la funcion hacemos que con el await espera hasta que retorne la promesa y no ejecute el setErrors antes y mande vacio. :OOO
